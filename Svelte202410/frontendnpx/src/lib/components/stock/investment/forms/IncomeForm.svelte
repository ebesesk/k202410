<script>
    ...
    let transaction = {
        ...
        type: 'DIVIDEND',  // DIVIDEND, INTEREST
        asset_id: '',
        currency: 'KRW',
        amount: 0,
        debit_account_id: '',
    ...
    // $: assets = $investmentStore.assets.filter(asset => 
    ...
    const incomeTypes = [
        ...
        { value: 'INTEREST', label: '이자수익' },
        { value: 'OTHER', label: '기타수익' }
    ];
    ...
    async function handleSubmit() {
        try {
            ...
            const url = '/stock/investments/v2/income';
